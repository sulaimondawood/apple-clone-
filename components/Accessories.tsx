...
const Accessories = () => {
  return (
    <div className="w-[300px] shadow-lg    rounded-xl px-6 pt-16 pb-6 flex flex-col justify-center items-center gap-4 bg-white">
      <img
      ...
      <div className="">
        ...
        <h1 className="text-xl  w-full text-m-black pb-3">
